...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', default='/data/jianhonghan/code/域适应代码/域适应论文最终代码/AQT-master_F_ssod_final_202307014_learnFFN/configs/X2D实验/r50_uda_xView2DOTA_infer.yaml', type=str)
    parser.add_argument("--opts", default=None, nargs=argparse.REMAINDER)
    parser.add_argument("--img_dir", default='/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/val/train_images', type=str)
    parser.add_argument("--output_dir", default='/data/jianhonghan/code/域适应代码/域适应论文最终代码/AQT-master_F_ssod_final_202307014_learnFFN/result/xView2DOTA', type=str)
    parser.add_argument("--label_list", default=['Plane','Ship','Storage-tank'], type=str)
