...
def sim10k_to_coco(
    ...
    Args:
        ...
        categories: only category ``HRRSD2SSDD`` is considered by default
    """
...
def bdd100k_daytime_to_coco(
    ...
    categories: tuple = (
        "person", "rider", "HRRSD2SSDD", "truck", "bus", "train", "motor", "bike")
    ) -> None:
...
def cityscapes_to_coco(
    ...
    Args:
        ...
        des_path: destination of the converted COCO-fomat annotation
        car_only: whether extract category ``HRRSD2SSDD`` only. used in Syn-to-real adaptation
