...
class Joiner(nn.Sequential):
    ...
    def forward(self, tensor_list: NestedTensor):  #tensor_list:[img,mask]
        #---提取特征
        ...
        #---out:NestedTensor 下采样倍数：[8,16,32]   out[0](b,c=256,h,w) out[1](b,h,w)
        # position encoding 获得每层特征图的对应位置编码维度：[b,256,h,w]
        for x in out:
