...
class CocoDetection(TvCocoDetection):
    def __init__(self, img_folder, ann_file, transforms, return_masks,strong_transforms = None,cache_mode=False, local_rank=0, local_size=1):
    ...
    def __getitem__(self, idx):
        ...
        img_strong_aug = None
        if self._transforms_strong is not None: #针对unlabel数据 使用强增广
